    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"> 
                <i class="bi bi-credit-card-fill fa-sm text-white-50"></i> Faire un paiement</a>
        </div>
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                    Consommation en Carburant </div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">10.000 FCFA</div>
                            </div>
                            <div class="col-auto">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4 text-center small">
                            <span class="mr-2">
                                <i class="fas fa-circle text-primary"></i> Cotisation
                            </span>
                            <span class="mr-2">
                                <i class="fas fa-circle text-success"></i> Payement
                            </span>
                            <span class="mr-2">
