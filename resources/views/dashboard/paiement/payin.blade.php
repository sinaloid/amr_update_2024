    ...
    curl_setopt_array($curl, array(
        ...
        CURLOPT_POSTFIELDS =>'
					  ...
					  "commande": {
						...
						"actions": {
						  "cancel_url": "http://localhost/erencci/admin",
						  "return_url": "http://localhost/erencci/pay-php-gateway/status_payin.php",
						  "callback_url": "http://localhost/erencci/pay-php-gateway/status_payin.php"
						},
						"custom_data": {
