        ...
        <tr>
            <td align="center">
                <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                ...
                                <tr>
                                    <td class="content-cell">
                                        ...
                                        <table class="subcopy" width="100%" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td>
                                                    {{ Illuminate\Mail\Markdown::parse($data['details']) }}
                                                    <span class="text-bold">AMR, Association Monde Rural</span>
                                                </td>
                                            </tr>
                                        </table>
                    ...
                    <tr>
                        <td>
                            <table class="footer bg-dark" align="center" width="570" cellpadding="0" cellspacing="0"
                                role="presentation">
                                @php
                                    $footer = '© ' . date('Y') . ' ' . config('app.name') . ' Tous droits réservés.';
                                @endphp
                                <tr>
                                    <td class="content-cell" align="center">
